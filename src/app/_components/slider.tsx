...
const Slider = () => {
  ...
  return (
    <div className="flex h-[calc(100vh-6rem)] flex-col md:h-[calc(100vh-9rem)] lg:flex-row bg-fuchsia-50">
      {/* TEXT CONTAINER  */}
      <div className="flex-1 flex flex-col items-center justify-center gap-8 font-bold text-red-500">
