...
DB_CONTAINER_NAME="nom_nom_now-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=nom_nom_now -d -p 5432:5432 docker.io/postgres
